...
Ordering trophies requires a few important decisions.
Below are some recommendations, but league leaders are entrusted to make the best choices for their league (and budget).

=== Do you want the option of giving a Judges' Choice Award?
This trophy is not included in the default “kit” (more information below).

It is **recommended** to order a trophy for this award so that your JA / Judges have the option, even if they ultimately choose not to give the award.
As a reminder, in terms of advancement points, the Judges’ Choice Award is worth just as much as other awards.

=== Do you want to give a Volunteer of the Year award?
This plaque is not included in the default "kit".
This award can be given at your league leadership’s discretion, and does not require the involvement of the judge crew.
...
Please balance the logistics, cost, and team experience as you see fit.
...
!!!danger Important
You should review the proofs very carefully within 24 hours.
Check all of the details, and especially:

- Ensure all awards are present in the trophy plates
- Ensure the spelling of the event is correct
- Ensure the program name is correctly capitalized and italicized: "_FIRST_ Tech Challenge"

Note that Sports Awards may provide duplicate trophy plates in the proofs.
!!!

After receiving the order, please perform a similarly thorough inspection.
If there are any issues, please contact Sports Awards and copy the Program Delivery Partner.
