...
Kickoff for the 2026–2027 _FIRST_ Tech Challenge game, BIOBUZZ™ presented by RTX, is on **September 12, 2026**.<br>
Game set orders for pre-kickoff shipment are due by **July 10, 2026**.
!!!
...
Here are a few important things to know when planning a kickoff event:
...
Game "leaks" erode trust in the program, and we should do everything we can to avoid them.
...
Pre-kickoff game sets require coordination between four different parties.
